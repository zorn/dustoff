defmodule DustoffWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DustoffWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DustoffWeb.Gettext, "errors", msg, opts)
    end
  end
